...
bwa mem -M -t 8 ${REF} ${three_CHIMP_folders}Pan_troglodytes_${chimp_name}/${fastq1} ${three_CHIMP_folders}Pan_troglodytes_${chimp_name}/${fastq2} | samtools sort -@ 16 -O bam \
