...
/scratch/devel/avalenzu/CNAG_interface/submit.py -c ${jobname} -o ${OUTDIR}Pan_troglodytes_${chimp_name}/out/${chimp_name}.downs.out -e ${OUTDIR}Pan_troglodytes_${chimp_name}/out/${chimp_name}.downs.err -n ${chimp_name}_${number} -u 1 -t 1 -w 23:30:00
done; done;
