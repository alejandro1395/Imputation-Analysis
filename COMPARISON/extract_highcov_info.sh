...
#create sample_file
python extract_variant_genotypes.py \
$INPUT \
$sample_name \
chr${chr} \
${OUTDIR}/Pan_troglodytes_${chimp_name}/chr${chr}/snp_ref_info" > ${OUTDIR}Pan_troglodytes_${chimp_name}/chr${chr}/qu/variants_highcov.sh 
jobname=$(echo ${OUTDIR}Pan_troglodytes_${chimp_name}/chr${chr}/qu/variants_highcov.sh)
chmod 777 $jobname
